# Approach : 1
# Train a convolutional neural network for binary class image classification using transfer learning
# The code is heavily inspired by this tutorial : https://pytorch.org/tutorials/beginner/transfer_learning_tutorial.html
